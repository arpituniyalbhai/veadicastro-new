    ...
    <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
      ...
      >
        ...
        <article className="mx-auto max-w-3xl px-4 pb-20 text-white/75">
          ...
          <p className="mb-5 leading-7">
              After the chart is ready, Vedika reads important parts of your Kundli. This includes your Sun sign, Moon sign, Lagna, Nakshatra, and planetary positions. If you want to verify the lunar foundation separately, the <Link to="/nakshatra-calculator" className="text-[#d9277a] hover:text-white">Nakshatra Calculator</Link> shows your exact birth star, pada, ruling planet, and sidereal Moon longitude. The prediction is then written according to your current age. A student, a young professional, and a married person should not receive the same kind of prediction. Your life stage matters, so the answer changes with your age.
          </p>

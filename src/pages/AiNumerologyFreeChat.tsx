        ...
        <section className="max-w-4xl mx-auto px-4 mb-20">
          <div className="prose prose-invert max-w-none">
            <article>
              ...
              <p className="text-white/80 leading-relaxed mb-4">
                Your full name is used to calculate your Destiny Number, Soul Urge Number, and Personality Number. Each letter in your name corresponds to a specific number, and those numbers reveal different aspects of your personality and life purpose. Your date of birth is used to calculate your Life Path Number, Birthday Number, and Personal Year Number. To compare numerology with Vedic lunar astrology, use our <a href="/rashi-calculator-by-date-of-birth" className="text-pink-400 hover:text-pink-300 underline underline-offset-4">Rashi Calculator by Date of Birth</a> and the <a href="/nakshatra-calculator" className="text-pink-400 hover:text-pink-300 underline underline-offset-4">Nakshatra Calculator</a> to find your exact birth star, pada, and ruling planet.
              </p>
              <p className="text-white/80 leading-relaxed mb-6">

        ...
        <section className="max-w-4xl mx-auto px-4 mb-20">
          ...
          <div className="card-glass rounded-3xl p-8 border border-white/10">
            ...
            <div className="space-y-6 text-white/80 leading-relaxed">
              ...
              <p>
                If you want the complete product overview before asking a question, the <a href="/" className="text-pink-400 hover:text-pink-300 underline underline-offset-4">Veadicastro homepage</a> explains Vedika AI, pricing, free tools, daily horoscope, Kundli generation, and detailed astrology reports in one place. For a complete birth chart analysis with planetary positions, doshas, yogas, and dasha, try our <Link to="/ai-kundli-analysis" className="text-pink-400 hover:text-pink-300 underline underline-offset-4">AI Kundli Analysis</Link> tool.
              </p>

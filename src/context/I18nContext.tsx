...
const dict: Dict = {
  ...
  unlock5Questions: { en: "Unlock 15 Questions - Only 399", hi: "Unlock 15 Questions - Only 399" },
  ...
  continueMyReading: { en: "Continue My Reading - Only ₹149", hi: "Continue My Reading - Only 149" },

...
const dict: Dict = {
  ...
  familyMembers: { en: "Family Members", hi: "परिवार के सदस्य" },
  ...
  onboardingTitle: { en: "Onboarding", hi: "ऑनबोर्डिंग" },
  ...
  welcomeMessage: { en: "Hi Again, {name}!", hi: "फिर से हाय, {name}!" },
  ...
  specialOfferExpires: { en: "⏰ Special offer expires in", hi: "⏰ ऑफर समाप्त होने में" },
  getQuestionsFor: { en: "— Get 15 questions for just ₹399!", hi: "— ₹399 में 15 प्रश्न पाएं!" },
  ...
  readingNotComplete: { en: "A big change is coming in your life in the next 30 days - especially related to your career or money.\n\nIf you ignore this, you could miss an important opportunity or decision.", hi: "Your next 30 days show a possible life change (career, money, or love)\nbut the full details are hidden in your chart" },
  ...
  bigChangeComing: { en: "A big change is coming in your life in the next 30 days - especially related to your career or money.", hi: "Your next 30 days show a possible life change (career, money, or love)" },

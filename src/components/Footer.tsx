      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-6 mb-8">
          ...
          <div className="flex flex-col items-start gap-3">
            ...
            <Link to="/ai-career-prediction-by-date-of-birth" className="text-white/80 hover:text-white transition-colors">
              Career Prediction Tool
            </Link>
            <Link to="/love-astrology-by-date-of-birth" className="text-white/80 hover:text-white transition-colors">
              Love Astrology Tool
            </Link>
            <Link to="/ai-future-spouse-prediction" className="text-white/80 hover:text-white transition-colors">
              Future Spouse Prediction
            </Link>
            <Link to="/ai-kundli-analysis" className="text-white/80 hover:text-white transition-colors">
              AI Kundli Analysis
            </Link>
            ...
            <Link to="/astrology-by-date-of-birth" className="text-white/80 hover:text-white transition-colors">
